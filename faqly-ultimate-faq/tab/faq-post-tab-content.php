...
<div class="form-group">
    ...
    <select name="faq_post_type" id="faq_post_type" class="form-control">
        <option value="faqly_faq" <?php selected( $faqly_post_type, 'faqly_faq' ); ?>>All Posts (FAQ)</option>
        <option value="post" <?php selected( $faqly_post_type, 'post' ); ?>>Normal Posts</option>
        <option value="page" <?php selected( $faqly_post_type, 'page' ); ?><?php echo esc_attr(faqly_field_disabled_attr( $faqly_is_premium_user )); ?>>Pages(<?php echo wp_kses_post(faqly_pro_label( $faqly_is_premium_user )); ?>)</option>
        <option value="product" <?php selected( $faqly_post_type, 'product' ); ?><?php echo esc_attr(faqly_field_disabled_attr( $faqly_is_premium_user )); ?>>Product(<?php echo wp_kses_post(faqly_pro_label( $faqly_is_premium_user )); ?>)</option>
        <option value="custom" <?php selected( $faqly_post_type, 'custom' ); ?><?php echo esc_attr(faqly_field_disabled_attr( $faqly_is_premium_user )); ?>>All Custom Posts(<?php echo wp_kses_post(faqly_pro_label( $faqly_is_premium_user )); ?>)</option>
    </select>
    ...
    <div class="form-group" style="margin-top: 15px;">
        ...
        <select name="faq_filter_posts" id="faq_filter_posts" class="form-control">
            ...
            <option value="taxonomy" <?php selected( get_post_meta( get_the_ID(), '_faq_filter_posts', true ), 'taxonomy' ); ?><?php echo esc_attr(faqly_field_disabled_attr( $faqly_is_premium_user )); ?>>Taxonomy (<?php echo wp_kses_post(faqly_pro_label( $faqly_is_premium_user )); ?>)</option>
            <option value="specific" <?php selected( get_post_meta( get_the_ID(), '_faq_filter_posts', true ), 'specific' ); ?><?php echo esc_attr(faqly_field_disabled_attr( $faqly_is_premium_user )); ?>>Specific Posts(<?php echo wp_kses_post(faqly_pro_label( $faqly_is_premium_user )); ?>)</option>
        </select>
    </div>
...
<div class="form-group">
    ...
    <select name="faq_order_by" id="faq_order_by" class="form-control">
        <option value="title" <?php selected( $faqly_order_by, 'title' ); ?>>Title</option>
        <option value="date" <?php selected( $faqly_order_by, 'date' ); ?>>Date</option>
        <option value="ID" <?php selected( $faqly_order_by, 'ID' ); ?>>ID</option>
    </select>
</div>
...
<div class="form-group">
    ...
    <select name="faq_order" id="faq_order" class="form-control">
        <option value="ASC" <?php selected($faqly_order, 'ASC'); ?>>Ascending</option>
        <option value="DESC" <?php selected($faqly_order, 'DESC'); ?>>Descending</option>
    </select>
</div>
